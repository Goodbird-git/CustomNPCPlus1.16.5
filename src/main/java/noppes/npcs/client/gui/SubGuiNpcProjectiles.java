...
public class SubGuiNpcProjectiles extends GuiBasic implements ITextfieldListener
{
    ...
    public SubGuiNpcProjectiles(final DataRanged stats) {
        this.trailNames = new String[] { "gui.none", "Smoke", "Portal", "Redstone", "Lightning", "LargeSmoke", "Magic", "Enchant", "Crit", "Lava", "Campfire Cosy Smoke",
    ...
    public void init() {
        ...
        this.addButton(new GuiButtonNop(this, 0, this.guiLeft + 60, this.guiTop + 100, 60, 20, new String[] { "gui.no", "gui.yes" }, (int)(this.stats.getHasGravity() ? 1 : 0)));
        if (!this.stats.getHasGravity()) {
            this.addButton(new GuiButtonNop(this, 1, this.guiLeft + 140, this.guiTop + 100, 60, 20, new String[] { "gui.constant", "gui.accelerate" }, (int)(this.stats.getAccelerate() ? 1 : 0)));
        }
        ...
        if (effect == 666) {
            effect = SubGuiNpcProjectiles.potionNames.length - 1;
        }
        this.addLabel(new GuiLabel(7, "stats.rangedeffect", this.guiLeft + 5, this.guiTop + 165));
        this.addButton(new GuiButtonBiDirectional(this, 4, this.guiLeft + 40, this.guiTop + 160, 100, 20, SubGuiNpcProjectiles.potionNames, effect));
        ...
        this.addButton(new GuiButtonNop(this, 7, this.guiLeft + 220, this.guiTop + 10, 30, 20, new String[] { "2D", "3D" }, (int)(this.stats.getRender3D() ? 1 : 0)));
        if (this.stats.getRender3D()) {
            this.addLabel(new GuiLabel(10, "stats.spin", this.guiLeft + 160, this.guiTop + 45));
            this.addButton(new GuiButtonNop(this, 8, this.guiLeft + 220, this.guiTop + 40, 30, 20, new String[] { "gui.no", "gui.yes" }, (int)(this.stats.getSpins() ? 1 : 0)));
            this.addLabel(new GuiLabel(11, "stats.stick", this.guiLeft + 160, this.guiTop + 75));
            this.addButton(new GuiButtonNop(this, 9, this.guiLeft + 220, this.guiTop + 70, 30, 20, new String[] { "gui.no", "gui.yes" }, (int)(this.stats.getSticks() ? 1 : 0)));
        }
        this.addButton(new GuiButtonNop(this, 6, this.guiLeft + 140, this.guiTop + 190, 60, 20, new String[] { "stats.noglow", "stats.glows" }, (int)(this.stats.getGlows() ? 1 : 0)));
    ...
    public void buttonEvent(final GuiButtonNop guibutton) {
        ...
        if (guibutton.id == 4) {
            ...
            if (effect == SubGuiNpcProjectiles.potionNames.length - 1) {
                effect = 666;
            }
